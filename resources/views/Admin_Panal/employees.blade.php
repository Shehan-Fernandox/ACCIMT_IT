            ...
            <main class="admin-main">
                <div class="container-fluid p-4 p-lg-5">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 mb-lg-5 mb-xl-6">
                        <div>
                            <h1 class="h3 mb-0">Employees Management</h1>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#userModal">
                                <i class="bi bi-person-plus me-2"></i>Add Employees
                            </button>
                        </div>
                    </div>
                                ...
                                <div class="card stats-card">
                                    <div class="card-body p-3 p-lg-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="mb-0 text-muted">Active Employees</h6>
                            ...
                            <div class="col-lg-8">
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="card-title mb-0">Employees Registration Trends</h5>
                            ...
                            <div class="col-lg-4">
                                <div class="card h-100">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Employees Distribution</h5>
                                    </div>
                                    <div class="card-body p-3 p-lg-4">
                                        <!-- Role Distribution -->
                                        <div class="mb-4">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h5 class="card-title mb-0">Employees Directory</h5>
                                    </div>
                                    <div class="col-auto">
                                        <div class="d-flex gap-2">
                                            <!-- Search -->
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="fw-medium text-primary">
                                                <span x-text="selectedUsers.length"></span> Employees<span x-show="selectedUsers.length !== 1">s</span> selected
                                            </span>
                                        </div>
                                        <div class="d-flex gap-2">
                ...
                <div class="modal-body">
                    <form x-data="userForm">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" @click="saveUser()">Save Employee</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="modal fade" id="importModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary">Import Employees</button>
                </div>
            </div>
        </div>
    </div>
